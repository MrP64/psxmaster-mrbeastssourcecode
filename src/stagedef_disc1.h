	...
	{ //StageId_5_1 (Cocoa)
		//Characters
		{Char_BF_New,      FIXED_DEC(240,1),   FIXED_DEC(70,1)},
		{Char_XmasP_New, FIXED_DEC(-20,1),   FIXED_DEC(90,1)},
		{Char_GF_New,       FIXED_DEC(150,1),  FIXED_DEC(0,1)},
		
		//Stage background
		Back_Week4_New,
		
		//Song info
		{FIXED_DEC(23,10),FIXED_DEC(27,10),FIXED_DEC(27,10)},
		5, 1,
		XA_Cocoa, 0,
